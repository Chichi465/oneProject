...
public class FatimaActivity {


    public static final String KEY_EatTodayQuestion = "EatTodayQuestion";
    public static final String KEY_WaterTodayQuestion = "WaterTodayQuestion";
    public static final String KEY_FoodGoodQuestion = "FoodGoodQuestion";
    public static final String KEY_MealsTodayQuestion = "MealsTodayQuestion";
    public static final String KEY_MeatTypeQuestion = "MeatTypeQuestion";
    ...
    private String eatTodayQuestion;
    private String waterTodayQuestion;
    private String foodGoodQuestion;
    private String mealsTodayQuestion;
    private String meatTypeQuestion;
    private int eatNo;
    private int eatYes;
